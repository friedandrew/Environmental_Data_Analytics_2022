...
> ANSWER: It is code NAD83, 4269. It is a geographic coordinate system, and it is in units of degrees
> 
...
NE_raw <- read.csv("../Data/Raw/NWIS_SiteInfo_NE_RAW.csv")
...
>ANSWER: The dec_lat and long columns disappeared and were replaced by the geometry column
>
...
NE_flow_join <- NE_flow %>% left_join(NE_sf, by = "site_no")
NE_flow_join <- st_as_sf(drop_na(NE_flow_join))


#17. Show the column names of the joined dataset
colnames(NE_flow_join)
...
ggplot()+
  geom_sf(data = Counties_sf)+
  geom_sf(data = NE_flow_join, aes(color = gage_ht))+
...
NE_flow_join_utm <- st_transform(NE_flow_join, crs = 32614)
Counties_sf_utm <- st_transform(Counties_sf, crs = 32614)

#21 Plot the data
ggplot()+
  geom_sf(data = Counties_sf_utm)+
  geom_sf(data = NE_flow_join_utm, aes(color = gage_ht))+
  scale_color_gradient(low = "blue", high = "red")
...
Lancaster <- Counties_sf_utm %>% filter(NAME == "Lancaster")

#23 Select gages within the selected county
NE_flow_join_utm_lancaster <- NE_flow_join_utm[Lancaster,]

#24 Plot
ggplot()+
  geom_sf(data = Counties_sf_utm)+
  geom_sf(data = NE_flow_join_utm_lancaster, aes(color = gage_ht))+
  scale_color_gradient(low = "blue", high = "red")
